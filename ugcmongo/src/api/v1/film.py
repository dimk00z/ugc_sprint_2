...
from models.models import (FilmInfo, FilmReview, FilmReviewAdd, FilmReviewInfo,
                           FilmVote, FilmVoteFilter)
from services.film import FilmService, get_film_service

router = APIRouter()


@router.get('/{film_id}/likes', response_model=FilmInfo,
            response_model_exclude_unset=True)
async def film_likes(film_id: str,
...
@router.post('/vote', response_model=FilmVote,
             response_model_exclude_unset=True)
...
@router.delete('/vote', response_model=FilmVote,
               response_model_exclude_unset=True)
...
@router.post('/review/info', response_model=FilmReviewInfo,
             response_model_exclude_unset=True)
...
@router.post('/review', response_model=FilmReview,
             response_model_exclude_unset=True)
...
@router.delete('/review', response_model=FilmReview,
               response_model_exclude_unset=True)
